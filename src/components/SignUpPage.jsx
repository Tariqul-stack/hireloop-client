          ...
          <div className="mb-8 flex flex-col items-center gap-3">
            ...
            <div className="text-center">
              ...
              <p
                ...
                style={{ color: "rgba(255,255,255,0.4)" }}
              >
                Join thousands of professionals on Programming Hero
              </p>
            </div>
          </div>
            ...
            <>
              ...
              <div className="flex flex-col gap-3 mb-6">
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2.5 rounded-xl border border-white/10 py-2.5 text-sm font-medium text-white transition-all hover:bg-white/5 active:scale-95"
